...
export const presets: Record<string, ThemeStyles> = {
  bluesky: {
    light: {
      ...
      foreground: 'oklch(0.17 0.01 254.15)',
      card: 'oklch(1.00 0 0)',
      'card-foreground': 'oklch(0.17 0.01 254.15)',
      popover: 'oklch(1.00 0 0)',
      'popover-foreground': 'oklch(0.17 0.01 254.15)',
      primary: 'oklch(0.62 0.20 255.93)',
      'primary-foreground': 'oklch(1.00 0 0)',
      secondary: 'oklch(0.96 0.00 247.80)',
      'secondary-foreground': 'oklch(0.45 0.04 248.80)',
      muted: 'oklch(0.96 0.00 247.80)',
      'muted-foreground': 'oklch(0.45 0.04 248.80)',
      accent: 'oklch(0.96 0.00 247.80)',
      'accent-foreground': 'oklch(0 0 0)',
      destructive: 'oklch(0.64 0.21 25.39)',
      border: 'oklch(0.89 0.01 247.95)',
      input: 'oklch(0.89 0.01 247.95)',
      ring: 'oklch(0.62 0.20 255.93)',
      'chart-1': 'oklch(0.62 0.20 255.93)',
      'chart-2': 'oklch(0.55 0.22 255.93)',
      'chart-3': 'oklch(0.49 0.22 255.93)',
      'chart-4': 'oklch(0.42 0.18 255.93)',
      'chart-5': 'oklch(0.38 0.14 255.93)',
      sidebar: 'oklch(0.98 0 0)',
      'sidebar-foreground': 'oklch(0.17 0.01 254.15)',
      'sidebar-primary': 'oklch(0.62 0.20 255.93)',
      'sidebar-primary-foreground': 'oklch(1 0 0)',
      'sidebar-accent': 'oklch(0.96 0.00 247.80)',
      'sidebar-accent-foreground': 'oklch(0 0 0)',
      'sidebar-border': 'oklch(0.89 0.01 247.95)',
      'sidebar-ring': 'oklch(0.62 0.20 255.93)',
    },
    dark: {
      background: 'oklch(0.23 0.0211 251.7)',
      foreground: 'oklch(0.96 0.0034 247.86)',
      card: 'oklch(0.28 0.0287 252.98)',
      'card-foreground': 'oklch(0.96 0.0034 247.86)',
      popover: 'oklch(0.28 0.0287 252.98)',
      'popover-foreground': 'oklch(0.96 0.0034 247.86)',
      primary: 'oklch(0.64 0.194 254.74)',
      'primary-foreground': 'oklch(0.96 0.0034 247.86)',
      secondary: 'oklch(0.31 0.0287 252.98)',
      'secondary-foreground': 'oklch(0.79 0.0246 250.13)',
      muted: 'oklch(0.3 0.0335 248.9)',
      'muted-foreground': 'oklch(0.71 0.0332 248.29)',
      accent: 'oklch(0.32 0.0335 248.9)',
      'accent-foreground': 'oklch(1 0 0)',
      destructive: 'oklch(0.64 0.21 25.39)',
      border: 'oklch(0.6 0.08 250.15 / 25%)',
      input: 'oklch(0.6 0.08 250.15 / 30%)',
      ring: 'oklch(0.64 0.194 254.74)',
      'chart-1': 'oklch(0.71 0.14 254.74)',
      'chart-2': 'oklch(0.64 0.194 254.74)',
      'chart-3': 'oklch(0.55 0.22 254.74)',
      'chart-4': 'oklch(0.49 0.22 254.74)',
      'chart-5': 'oklch(0.42 0.18 254.74)',
      sidebar: 'oklch(0.21 0.01 285.93)',
      'sidebar-foreground': 'oklch(0.96 0.0034 247.86)',
      'sidebar-primary': 'oklch(0.64 0.194 254.74)',
      'sidebar-primary-foreground': 'oklch(0.96 0.0034 247.86)',
      'sidebar-accent': 'oklch(0.32 0.0335 248.9)',
      'sidebar-accent-foreground': 'oklch(1 0 0)',
      'sidebar-border': 'oklch(0.6 0.08 250.15 / 25%)',
      'sidebar-ring': 'oklch(0.64 0.194 254.74)'
    }
  },
  valorant: {
    light: {
